import{_ as o,r as e,o as i,c as l,b as n,d as s,a,e as t}from"./app-0e478424.js";const u="/vuepress/assets/vuepress-36-ad1f4ff8.png",r="/vuepress/assets/vuepress-37-83d44ec7.png",d="/vuepress/assets/vuepress-38-04c66bb1.png",k={},v=t(`<h1 id="样式美化" tabindex="-1"><a class="header-anchor" href="#样式美化" aria-hidden="true">#</a> 样式美化</h1><div class="custom-container warning"><p class="custom-container-title">更新时间</p><p>最近更新：2023-7-3</p><p>搭建版本：v2.0-beta.63</p></div><h2 id="palette-文件" tabindex="-1"><a class="header-anchor" href="#palette-文件" aria-hidden="true">#</a> Palette 文件</h2><div class="custom-container tip"><p class="custom-container-title">说明</p><p>若无必要，不建议修改</p><p>修改方式请参照style，一样的</p></div><div class="language-目录 line-numbers-mode" data-ext="目录"><pre class="language-目录"><code>├─ docs
│  ├─ .vuepress
│  │  └─ styles
│  │      └─ palette.scss   &lt;--- 样式变量
└─ README.md
...
<span class="token punctuation">}</span>
&lt;/style&gt;
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p><img src="`+u+`" alt=""></p><p>其他页面也是可以更改的，可以参照官方进行更改</p><div class="language-路径 line-numbers-mode" data-ext="路径"><pre class="language-路径"><code>原始路径：node_modules\\@vuepress\\theme-default\\lib\\client\\styles
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div><h2 id="代码精简" tabindex="-1"><a class="header-anchor" href="#代码精简" aria-hidden="true">#</a> 代码精简</h2><p>上面我们发现引用可以index进行引用，那么我们其他代码是否可以呢，以便达到代码简化</p><p>我们以<code>侧边栏导航</code>为例，看目录</p><div class="language-目录 line-numbers-mode" data-ext="目录"><pre class="language-目录"><code>├─ docs
│  ├─ .vuepress
│  │  └─ configs
│  │      └─ index.ts     &lt;--- 主配置文件
│  │      └─ sidebar.ts   &lt;--- 侧边栏配置文件
