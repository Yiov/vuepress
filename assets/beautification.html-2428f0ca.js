import{_ as o,r as p,o as i,c as l,b as s,d as n,a as t,e as a}from"./app-86b6e97a.js";const u="/vuepress/assets/vuepress-36-ad1f4ff8.png",r="/vuepress/assets/vuepress-37-83d44ec7.png",d="/vuepress/assets/vuepress-38-04c66bb1.png",k={},v=a(`<h1 id="样式美化" tabindex="-1"><a class="header-anchor" href="#样式美化" aria-hidden="true">#</a> 样式美化</h1><div class="custom-container warning"><p class="custom-container-title">更新时间</p><p>最近更新：2023-3-26</p><p>搭建版本：v2.0-beta.61</p></div><h2 id="palette-文件" tabindex="-1"><a class="header-anchor" href="#palette-文件" aria-hidden="true">#</a> Palette 文件</h2><div class="custom-container tip"><p class="custom-container-title">说明</p><p>若无必要，不建议修改</p><p>修改方式请参照style，一样的</p></div><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>├─ docs
│  ├─ .vuepress
│  │  └─ styles
│  │      └─ palette.scss   &lt;--- 样式变量
└─ README.md
...
<span class="token punctuation">}</span>
</code></pre><div class="highlight-lines"><br><br><br><br><br><div class="highlight-line"> </div><div class="highlight-line"> </div><br><br></div><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,21),b=a(`<div class="custom-container tip"><p class="custom-container-title">说明</p><p>style代码里不要含有//等注释符号</p></div><div class="language-scss line-numbers-mode" data-ext="scss"><pre class="language-scss"><code><span class="token selector">&lt;style&gt;
...
<span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token punctuation">{</span>
  ...
  <span class="token punctuation">}</span><span class="token punctuation">)</span>
<span class="token punctuation">}</span>
</code></pre><div class="highlight-lines"><br><br><br><br><div class="highlight-line"> </div><div class="highlight-line"> </div><br><br></div><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div><p>同样的我们还可以进行导航栏的简化，这里就不演示了</p><h2 id="项目徽标" tabindex="-1"><a class="header-anchor" href="#项目徽标" aria-hidden="true">#</a> 项目徽标</h2><p>无论文档还是github项目都会见到这种</p><p><img src="`+r+'" alt=""></p>',20),m={href:"https://shields.io/",target:"_blank",rel:"noopener noreferrer"},g=a('<p><code>serch</code> 处输入你的github项目链接，选择要生成的徽标，生成后，选择Markdown格式即可</p><p><img src="'+d+`" alt=""></p><h2 id="组件替换" tabindex="-1"><a class="header-anchor" href="#组件替换" aria-hidden="true">#</a> 组件替换</h2><p>对某个布局不满意，我们可以直接替换</p><p>我们以 <code>主页</code> 布局演示</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>├─ docs
│  ├─ .vuepress
│  │  └─ components
│  │      └─ MyHome.vue     &lt;--- 主页组件
└─ README.md
...
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div></div></div>`,12);function y(h,f){const e=p("Badge"),c=p("ExternalLinkIcon");return i(),l("div",null,[v,s("p",null,[n("另一种是直接在页面引用style代码，比如：在 "),t(e,{type:"warning",text:"首页README.md文件",vertical:"middle"}),n(" 里添加")]),b,s("p",null,[n("官网："),s("a",m,[n("https://shields.io/"),t(c)])]),g])}const w=o(k,[["render",y],["__file","beautification.html.vue"]]);export{w as default};
