...
</code></pre><div class="highlight-lines"><br><div class="highlight-line"> </div><br></div><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,4),_={href:"https://yiov.github.io/",target:"_blank",rel:"noopener noreferrer"},y=i(`<p>但如果不是根路径，比如某个仓库 <code>vuepress2</code> 那么配置要更改为</p><div class="language-typescript line-numbers-mode" data-ext="ts"><pre class="language-typescript"><code><span class="token keyword">export</span> <span class="token keyword">default</span> <span class="token punctuation">{</span>
...
<span class="token punctuation">}</span>
</code></pre><div class="highlight-lines"><br><div class="highlight-line"> </div><br><br><br><br><br></div><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,2),f={href:"https://yiov.github.io/vuepress2/",target:"_blank",rel:"noopener noreferrer"},x=i(`<h2 id="配置工作流" tabindex="-1"><a class="header-anchor" href="#配置工作流" aria-hidden="true">#</a> 配置工作流</h2><p>新建文件 <code>.github/workflows/docs.yml</code> ，将下面yml信息粘贴进去</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>├─ docs
├─ .github
│    └─ workflows
│         └─ docs.yml  &lt;--- yml工作流
└─ .gitignore
</code></pre><div class="line-numbers" aria-hidden="true"><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div><div class="line-number"></div></div></div>`,3),w={class:"custom-container tip"},G=n("p",{class:"custom-container-title"},"注意",-1),B={href:"https://docs.github.com/zh/actions",target:"_blank",rel:"noopener noreferrer"},N=i(`<div class="custom-container warning"><p class="custom-container-title">注意</p><p>经过反复测试，还是没搞定，于是弃用了</p><p>这是一个已经配置好的工作流，自己记得删掉注释！！！</p><p>实际是github分配了一个虚拟机给你使用，里面的ubuntu系统以及pnpm都是虚拟机使用的，与自己的无关，不要动就行</p></div><details class="custom-container details"><summary>点击查看代码</summary><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">name</span><span class="token punctuation">:</span> docs
...
`)])]),n("div",{class:"line-numbers","aria-hidden":"true"},[n("div",{class:"line-number"})])],-1),V=n("div",{class:"language-bash line-numbers-mode","data-ext":"sh"},[n("pre",{class:"language-bash"},[n("code",null,[n("span",{class:"token function"},"npm"),s(` docs:build
`)])]),n("div",{class:"line-numbers","aria-hidden":"true"},[n("div",{class:"line-number"})])],-1),E=n("p",null,[s("打包完成后，在 "),n("code",null,"docs/.vuepress/dist"),s(" 目录，将"),n("code",null,"dist"),s("上传到网站或者仓库即可")],-1),H=n("p",null,[n("img",{src:r,alt:""})],-1),T=n("p",null,"手动上传到github的，需要在设置-page里把分支改成main，默认root，保存等创建成功后即可获得访问链接",-1),z=n("p",null,[n("img",{src:v,alt:""})],-1);function j(P,S){const e=l("ExternalLinkIcon"),p=l("CodeGroupItem"),c=l("CodeGroup");return u(),d("div",null,[k,b,n("p",null,[s("主要讲一下github，其他的方式都大同小异，"),n("a",h,[s("更多部署方式可以参考官方文档"),a(e)])]),g,n("p",null,[s("访问的网址就是："),n("a",_,[s("https://yiov.github.io/"),a(e)])]),y,n("p",null,[s("访问的网址就是："),n("a",f,[s("https://yiov.github.io/vuepress2/"),a(e)])]),x,n("div",w,[G,n("p",null,[s(".github 与 docs为同级目录，有兴趣"),n("a",B,[s("GitHub Actions 深入了解"),a(e)])])]),N,a(c,null,{default:t(()=>[a(p,{title:"pnpm"},{default:t(()=>[C]),_:1}),a(p,{title:"yarn"},{default:t(()=>[I]),_:1}),a(p,{title:"npm"},{default:t(()=>[V]),_:1})]),_:1}),E,H,T,z])}const L=o(m,[["render",j],["__file","assets.html.vue"]]);export{L as default};
